...
from backend.data.experiments import ExperimentRun
from backend.embedding_validation import (
    BenchmarkResult,
    SimilarityMetrics,
...
class EvaluationMetrics:
    ...
    # Overall scores
    overall_faithfulness: Optional[float] = None
        ...
        for evaluator in self.evaluators:
            try:
                ...
                if hasattr(evaluator, 'evaluator_type'):
                    ...
                    if evaluator_name in ["faithfulness", "answer_relevancy", "context_precision", "context_recall", "context_relevancy", "answer_correctness"]:
                        ragas_results.append(results)
                    else:
                        deepeval_results.append(results)
