...
class APISettings(BaseSettings):
    ...
    # --- Server ----------------------------------------------------------------
    host: str = Field(
        default="0.0.0.0", description="Bind host for the HTTP server."
    )  # nosec B104: standard for containerized deployments behind reverse proxy; overridden via API_HOST
